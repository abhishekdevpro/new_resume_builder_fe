...
const LoadUnload = () => {
  ...
  const [showLoadingAnimation, setShowLoadingAnimation] = useState(false); // To control loading animation visibility
  ...
  const handleStartFromScratch = () => {
    setShowLoadingAnimation(true); // Show animation when starting from scratch
    setTimeout(() => {
      setShowLoadingAnimation(false);
  ...
  return (
    <>
      ...
      {showLoadingAnimation && (
        <div className="fixed  inset-0 z-50 justify-items-center flex items-center justify-center bg-gray-900 ">
        

          <div className="loader"></div>
          <div className="ms-5 text-white text-2xl">
